...
- Erreurs fréquentes :
  ...
  - ⚠️ Le tool calling via MCP peut être **capricieux avec un petit modèle local** : au lieu d'exécuter l'appel, l'agent « invente » parfois un appel d'outil sous forme de texte dans sa réponse. Réessayez ou reformulez la question ; ce n'est pas un bug de votre code.
